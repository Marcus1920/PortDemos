     ...
     {!! Form::hidden('poiID',$poi->id,['id' => 'poiID']) !!}
       ...
       <div class="tab-container tile">
            ...
            <ul class="nav tab nav-tabs">
                ...
                <li><a href="#identification">IDENTIFICATION DOCUMENTS</a></li>
            ...
            <div class="tab-content">
                    ...
                    <div class="">
                        ...
                        <div class="row">
                             <div class="col-md-4">
                                ...
                                {!! Form::select('religion',$selectReligions,$poi->religion,['class' => 'form-control input-sm m-b-10' ,'id' => 'religion']) !!}
                              
                            </div>
                             <div class="col-md-4">
                                
                                {!! Form::label('Position', 'Position', array('class' => '')) !!}
                                {!! Form::select('position',$selectPositions,$poi->position,['class' => 'form-control input-sm m-b-10' ,'id' => 'position']) !!}
                              
                            </div>

                             <div class="col-md-4">
                                
                                {!! Form::label('Highest Qualification', 'Highest Qualification', array('class' => '')) !!}
                                {!! Form::select('qualification_type',$selectQualificationTypes,$poi->qualification_type,['class' => 'form-control input-sm m-b-10' ,'id' => 'qualification_type']) !!}
                ...
                <div class="tab-pane" id="identification">
                  ...
                  <div class="block-area">
                    <h3 class="block-title">POI IDENTIFICATION DOCUMENTS </h3><br>
                    <div class="row">
                        ...
                        <div class="col-md-4 passportnumber @if($poi->document_type == 1) hidden @endif">
                         ...
                         <div class="col-md-4">
                                ...
                                {!! Form::label('ID/Passport Expiry Date', 'ID/Passport Expiry Date', array('class' => '')) !!}
                               

                                <div class="input-icon datetime-pick date-only">
                                <input data-format="yyyy-MM-dd" type="text" value="{{ $poi->doc_expiry_date }}" name="doc_expiry_date" class="form-control input-sm m-b-10" />
                                <span class="add-on">
                                <i class="sa-plus"></i>
                                </span>
                                </div>
                            ...
                            <div class="col-md-4  passportnumber @if($poi->document_type == 1) hidden @endif">
                                ...
                                {!! Form::label('Work Permit', 'Work Permit', array('class' => '')) !!}
                                {!! Form::text('work_permit',$poi->work_permit,['class' => 'form-control input-sm m-b-10','id' => 'work_permit']) !!}

                            </div>

                            <div class="col-md-4  passportnumber @if($poi->document_type == 1) hidden @endif">

                                {!! Form::label('Work Permit Expiry Date', 'Work Permit Expiry Date', array('class' => '')) !!}
                               

                                <div class="input-icon datetime-pick date-only">
                                <input data-format="yyyy-MM-dd" type="text" name="work_permit_expiry_date" value="{{ $poi->work_permit_expiry_date }}" class="form-control input-sm m-b-10" />
                                <span class="add-on">
                                <i class="sa-plus"></i>
                                </span>
                                </div>
                            ...
                            <div class="col-md-4 passportnumber @if($poi->document_type == 1) hidden @endif">
                                ...
                                {!! Form::label('Yellow Fever', 'Yellow Fever', array('class' => '')) !!}
                                {!! Form::text('yellow_fever',$poi->yellow_fever,['class' => 'form-control input-sm m-b-10','id' => 'yellow_fever']) !!}

                            </div>
                            <div class="col-md-4 passportnumber @if($poi->document_type == 1) hidden @endif">

                                {!! Form::label('Yellow Fever Expiry Date', 'Yellow Fever Expiry Date', array('class' => '')) !!}
                               

                                <div class="input-icon datetime-pick date-only">
                                <input data-format="yyyy-MM-dd" type="text" value="{{ $poi->yellow_fever_expiry_date }}" name="yellow_fever_expiry_date" class="form-control input-sm m-b-10" />
                                <span class="add-on">
                                <i class="sa-plus"></i>
                                </span>
                                </div>
                  ...
                  <div class="block-area">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            {!! Form::select('has_vehicle',['0' => 'Has a vehicle ?','1' => 'No','2' => 'Yes'],0,['class' => 'form-control input-sm m-b-10 has_vehicle' ,'id' => 'has_vehicle']) !!}
                                  ...
                                  <div class="block-area" id="inline">
                                      <div class="row">
                                          ...
                                          <div class="form-group">
                                            {!! Form::label('Enter Residential Location', 'Residential Location', array('class' => 'col-md-3 control-label')) !!}
              ...
              <div class="tab-pane" id="training">
                ...
                <div class="block-area">
                    <h3 class="block-title">TRAINING DETAILS</h3><br>
                    <div class="row">
                            ...
                            <div class="block-area" id="inline">
                                ...
                                <div class="row">
                                     ...
                                     <div class="col-md-4">
                                       ...
                                       <a href="#"   class="addTraining btn btn-sm"><i class="fa fa-plus" aria-hidden="true"></i> Training</a>
                    ...
                    <div id="training_container">
                          ...
                          @if(isset($poi->trainings))
                              @foreach ($poi->trainings as $training)
                                ...
                                <div class="row">
                                     ...
                                     <div class="col-md-4">
                                        ...
                                        {!! Form::label('Training Type', 'Training Type', array('class' => '')) !!}
                                        {!! Form::select('training_type[]',$selectTrainingTypes,$training->training_type,['class' => 'form-control input-sm m-b-10' ,'id' => 'training_type']) !!}
                              
                                     </div>

                                    <div class="col-md-4">

                                        {!! Form::label('Years Served', 'Years Served', array('class' => '')) !!}
                                        {!! Form::text('training_years[]',$training->years,['class' => 'form-control input-sm m-b-10','id' => 'training_years']) !!}
                                     ...
                                     <div class="col-md-4">
                                        ...
                                        {!! Form::text('training_location[]',$training->location,['class' => 'form-control input-sm m-b-10','id' => 'training_location']) !!}
                      ...
                      <div class="block-area">
                          ...
                          <div class="row">
                                    ...
                                    <div class="col-md-6">
                                      ...
                                      {!! Form::label('Notice Period', 'Notice Period', array('class' => 'col-md-3 control-label')) !!}
                                        
                                      {!! Form::text('notice_period',$poi->notice_period,['class' => 'form-control input-sm m-b-10','id' => 'notice_period']) !!}
                              ...
                              <div class="col-md-6">
                                  ...
                                  <div class="block-area" id="inline">
                                      <div class="row">
                                          ...
                                          <div class="form-group">
                                            {!! Form::label('Enter Work Location', 'Work Location', array('class' => 'col-md-3 control-label')) !!}
...
function removeResAddress(node) {
 ...
 $(".addTraining").click(function(){
        ...
        generate_training_html();

})


function generate_training_html(){

    var html  = "";
        html  +="<div class='row'>";
        html  +="<div class='col-md-4'>";
        html  +='{!! Form::label("Training Type", "Training Type", array("class" => "")) !!}';
        html  +='{!! Form::select("training_type[]",$selectTrainingTypes,0,["class" => "form-control input-sm m-b-10" ,"id" => "training_type"]) !!}';
        html  +='</div>';
        html  +='<div class="col-md-4">';
        html  +='{!! Form::label("Years Served", "Years Served", array("class" => "")) !!}';
        html  +='{!! Form::text("training_years[]",NULL,["class" => "form-control input-sm m-b-10","id" => "training_years"]) !!}';
        html  +='</div>';
        html  +='<div class="col-md-4">';
        html  +='{!! Form::label("Location", "Location", array("class" => "")) !!}';
        html  +='{!! Form::text("training_location[]",NULL,["class" => "form-control input-sm m-b-10","id" => "training_location"]) !!}';
        html  +='</div>';
        html  +='</div>'; 

        $("#training_container").append(html);                                 
