...
<div class="block-area" id="basic">
    ...
    <div class="tile p-15">
        {!! Form::open(['url' => 'users', 'method' => 'post', 'class' => 'form-horizontal', 'id'=>"registrationForm" ]) !!}
            ...
            <div class="form-group">
              {!! Form::label('Route', 'Street', array('class' => 'col-md-2 control-label')) !!}
              <div class="col-md-6">
            ...
            <div class="form-group">
              {!! Form::label('Locality', 'City', array('class' => 'col-md-2 control-label')) !!}
              <div class="col-md-6">
            ...
            <div class="form-group">
              {!! Form::label('Area', 'Province', array('class' => 'col-md-2 control-label')) !!}
              <div class="col-md-6">
            ...
            <div class="form-group">
                {!! Form::label('Association', 'Affiliation', array('class' => 'col-md-2 control-label')) !!}
                <div class="col-md-6">
			...
			<div class="form-group">
                {!! Form::label('User  Role', 'User Group', array('class' => 'col-md-2 control-label')) !!}
                <div class="col-md-6">
